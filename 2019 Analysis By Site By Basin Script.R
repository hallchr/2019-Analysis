...
SC_HC <- ggplot(subset(AllCountsAmbient2019, Monitoring.Basin == "Horse Creek"), aes(Site, Specific.Cond)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "red4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
...
SC_LS <- ggplot(subset(AllCountsAmbient2019, Monitoring.Basin == "Little Swamp Creek"), aes(Site, Specific.Cond)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "purple4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,400) +
...
SC_LNC <- ggplot(subset(AllCountsAmbient2019, Monitoring.Basin == "Lower North Creek"), aes(Site, Specific.Cond)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "springgreen4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,400) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) + #geom_hline(yintercept = 0.04, color = "orange2", size = 1) + #geom_hline(yintercept = 0.04, color = "orange2", size = 1) + geom_hline(yintercept = 0.178, color = "red", size=1) +
...
SC_LSR <- ggplot(subset(AllCountsAmbient2019, Monitoring.Basin == "Lower Sammamish River"), aes(Site, Specific.Cond)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "slategray4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,400) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) + #geom_hline(yintercept = 0.04, color = "orange2", size = 1) + #geom_hline(yintercept = 0.04, color = "orange2", size = 1) + geom_hline(yintercept = 0.178, color = "red", size=1) +
...
SC_PC <- ggplot(subset(AllCountsAmbient2019, Monitoring.Basin == "Perry Creek"), aes(Site, Specific.Cond)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "turquoise4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,400) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) + #geom_hline(yintercept = 0.04, color = "orange2", size = 1) + #geom_hline(yintercept = 0.04, color = "orange2", size = 1) + geom_hline(yintercept = 0.178, color = "red", size=1) +
...
SC_UNC <- ggplot(subset(AllCountsAmbient2019, Monitoring.Basin == "Upper North Creek"), aes(Site, Specific.Cond)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "salmon4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,400) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) + #geom_hline(yintercept = 0.04, color = "orange2", size = 1) + #geom_hline(yintercept = 0.04, color = "orange2", size = 1) + geom_hline(yintercept = 0.178, color = "red", size=1) +
...
SC_PA <- ggplot(subset(AllCountsAmbient2019, Monitoring.Basin == "Parr Creek"), aes(Site, Specific.Cond)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "salmon4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,400) +
...
SpC_Table_Basin <- summaryStats(Specific.Cond ~ Monitoring.Basin, data = AllCountsAmbient2019, digits=3, p.value=TRUE, stats.in.rows=TRUE,
                               test.arg.list=list(var.equal = FALSE, test="nonparametric"))
...
Zn_PA <- ggplot(subset(AllCountsAmbient2019, Monitoring.Basin == "Parr Creek"), aes(Site, Zn)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "salmon4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,150) + 
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) + geom_hline(yintercept = 32, color = "orange2", size = 1) + geom_hline(yintercept = 35, color = "red", size=1) +
...
Cu_PA <- ggplot(subset(AllCountsAmbient2019, Monitoring.Basin == "Parr Creek"), aes(Site, Cu)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "salmon4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,6) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) + geom_hline(yintercept = 3.47, color = "orange2", size = 1) + geom_hline(yintercept = 4.61, color = "red", size=1) +
...
Pb_PA <- ggplot(subset(AllCountsAmbient2019, Monitoring.Basin == "Parr Creek"), aes(Site, Pb)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "salmon4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,2) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) + geom_hline(yintercept = 0.541, color = "orange2", size = 1) + geom_hline(yintercept = 13.88, color = "red", size=1) +
...
grid.arrange(Zn_HC, Zn_LS, Zn_PC, Zn_LNC, Zn_UNC, Zn_LSR, Zn_PA, Cu_HC, Cu_LS, Cu_PC, Cu_LNC, Cu_UNC, Cu_LSR, Cu_PA, Pb_HC, Pb_LS, Pb_PC, Pb_LNC, Pb_UNC, Pb_LSR, Pb_PA, nrow = 3)
...
Pb_Table_Basin <- summaryStats(Pb ~ Monitoring.Basin, data = AllCountsAmbient2019, digits=3, p.value=TRUE, stats.in.rows=TRUE,
                                test.arg.list=list(var.equal = FALSE, test="nonparametric"))
...
Turb_PA <- ggplot(subset(AllCountsAmbient2019, Monitoring.Basin == "Parr Creek"), aes(Site, Turbidity)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "salmon4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,25) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) + geom_hline(yintercept = 4, color = "orange2", size = 1) + geom_hline(yintercept = 70, color = "red", size=1) +
...
TSS_PA <- ggplot(subset(AllCountsAmbient2019, Monitoring.Basin == "Parr Creek"), aes(Site, TSS)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "salmon4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,180) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) + geom_hline(yintercept = 33, color = "orange2", size = 1) +
...
grid.arrange(Turb_HC, Turb_LS, Turb_PC, Turb_LNC, Turb_UNC, Turb_LSR, Turb_PA, TSS_HC, TSS_LS, TSS_PC, TSS_LNC, TSS_UNC, TSS_LSR, TSS_PA, nrow = 2)
...
Turb_Table_Basin <- summaryStats(Turbidity ~ Monitoring.Basin, data = AllCountsAmbient2019, digits=3, p.value=FALSE, stats.in.rows=TRUE,
                                test.arg.list=list(var.equal = FALSE, test="nonparametric"))
...
TSS_Table_Basin <- summaryStats(TSS ~ Monitoring.Basin, data = AllCountsAmbient2019, digits=3, p.value=FALSE, stats.in.rows=TRUE,
                                 test.arg.list=list(var.equal = FALSE, test="nonparametric"))
...
Fecal_PA <- ggplot(subset(AllCountsAmbient2019, Monitoring.Basin == "Parr Creek"), aes(Site, Fecal.Coliform)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "turquoise4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,3000) + geom_hline(yintercept = 50, color="red", size=1) + geom_hline(yintercept = 200, color="blue", size=1) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) + 
...
BIBI_HC <- ggplot(subset(BIBISub2019, Monitoring.Basin == "Horse Creek"), aes(Site, BIBI)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "red4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
...
BIBI_LS <- ggplot(subset(BIBISub2019, Monitoring.Basin == "Little Swamp Creek"), aes(Site, BIBI)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "purple4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
...
BIBI_LNC <- ggplot(subset(BIBISub2019, Monitoring.Basin == "Lower North Creek"), aes(Site, BIBI)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "springgreen4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,100) + geom_hline(yintercept = 20, color="red", size=1) + geom_hline(yintercept = 40, color="Yellow", size=1) + geom_hline(yintercept = 60, color= "palegreen1", size=1) +  geom_hline(yintercept = 80, color= "palegreen4", size=1) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) +
...
BIBI_LSR <- ggplot(subset(BIBISub2019, Monitoring.Basin == "Lower Sammamish River"), aes(Site, BIBI)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "slategray4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,100) + geom_hline(yintercept = 20, color="red", size=1) + geom_hline(yintercept = 40, color="Yellow", size=1) + geom_hline(yintercept = 60, color= "palegreen1", size=1) +  geom_hline(yintercept = 80, color= "palegreen4", size=1) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) +
...
BIBI_PC <- ggplot(subset(BIBISub2019, Monitoring.Basin == "Perry Creek"), aes(Site, BIBI)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "turquoise4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,100) + geom_hline(yintercept = 20, color="red", size=1) + geom_hline(yintercept = 40, color="Yellow", size=1) + geom_hline(yintercept = 60, color= "palegreen1", size=1) +  geom_hline(yintercept = 80, color= "palegreen4", size=1) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) + 
...
BIBI_PA <- ggplot(subset(BIBISub2019, Monitoring.Basin == "Parr Creek"), aes(Site, BIBI)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "turquoise4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,100) + geom_hline(yintercept = 20, color="red", size=1) + geom_hline(yintercept = 40, color="Yellow", size=1) + geom_hline(yintercept = 60, color= "palegreen1", size=1) +  geom_hline(yintercept = 80, color= "palegreen4", size=1) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL) + 
...
BIBI_UNC <- ggplot(subset(BIBISub2019, Monitoring.Basin == "Upper North Creek"), aes(Site, BIBI)) + 
  facet_wrap(~Monitoring.Basin, ncol = 1) + geom_boxplot(fill = "salmon4", width = 0.4, color = "darkcyan", alpha = 0.7)  +
  stat_summary(fun.y= "mean", colour="black", geom="point", 
               shape=18, size=3,show_guide = FALSE) + ylim(0,100) + geom_hline(yintercept = 20, color="red", size=1) + geom_hline(yintercept = 40, color="Yellow", size=1) + geom_hline(yintercept = 60, color= "palegreen1", size=1) +  geom_hline(yintercept = 80, color= "palegreen4", size=1) +
  labs(title = NULL, subtitle=NULL, y=NULL, x=NULL)  +
...
BIBI_Table_Basin <- summaryStats(BIBI ~ Monitoring.Basin, data = BIBISub2019, digits=3, p.value=FALSE, stats.in.rows=TRUE,
                               test.arg.list=list(var.equal = FALSE, test="nonparametric"))
